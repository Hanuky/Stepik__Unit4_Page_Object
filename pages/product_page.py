...
class ProductPage(BasePage):
    ...
    def chek_price_equals_basket_price(self):
        assert self.chek_product_price() == self.chek_product_price_in_basket(), "Product price or product price in basket wrong"
    def chek_product_name_equal_product_basket_name(self): 
        assert self.chek_product_name() == self.chek_product_basket_name(), "Product name or product name in basket wrong"      
