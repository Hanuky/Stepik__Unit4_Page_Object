...
class ProductPage(BasePage):
    ...
    def check_price_equals_basket_price(self):
        assert self.check_product_price() == self.check_product_price_in_basket(), "Product price or product price in basket not equals"
    
    def check_product_name_equal_product_basket_name(self): 
        assert self.check_product_name() == self.check_product_basket_name(), "Product name or product name in basket not equals" 
